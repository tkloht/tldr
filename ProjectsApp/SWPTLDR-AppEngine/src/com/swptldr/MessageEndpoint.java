 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "swptldr.com", ownerName = "swptldr.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyAnXdyVsFG4hwtZrrN2CB5Bkj-G0IRG-WE";
