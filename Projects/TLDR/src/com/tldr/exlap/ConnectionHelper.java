...
public class ConnectionHelper implements DataListener, DiscoveryListener {
        ...
        public void handleMessage(Message msg) {
            ...
            for (int i = 0; i < dataObject.size(); i++) {
                ...
                if (dataElement.getState() == 1) {
                    ...
                    String value = dataElement.getValue().toString().equals("") ? "null" : dataElement.getValue()
                            .toString();
                }
            }
        }
    ...
    public void onData(DataObject dataObject) {
        ...
        if (dataObject != null) {
            m_carInfoHandler.sendMessage(m_carInfoHandler.obtainMessage(1, dataObject));
        }
    }
     ...
     * 
     * @param address Socket address e.g. "socket://192.168.1.76:28500"
     */
    ...
    private class SubscribeAllInterfaces extends AsyncTask<Void, Integer, Integer> {
    	@Override
    ...
    public void unsubscribeAll() throws IllegalArgumentException, IOException, ExlapException {
    ...
    public void performDiscovery() throws IOException {
        DiscoveryManager disco = new DiscoveryManager(DiscoveryManager.SCHEME_SOCKET);
        try {
