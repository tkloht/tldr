...
//				service.insertTask(new Task().setTitle("Besuche den GroÃŸmeister")
...
//								.setGeoLat(52.5753192766).setGeoLon(13.3531235291).setGoals(goals_two)).execute();
				service.insertTask(new Task().setTitle("Zeugenschutzprogram!")
						.setDescription("Ihr habt es geschafft einen Anhänger des Ministry of Freedom zum überlaufen zu bringen. Dieser Zeuge hat wichtige Informationen und muss nun vor den Feind geschützt werden. " +
