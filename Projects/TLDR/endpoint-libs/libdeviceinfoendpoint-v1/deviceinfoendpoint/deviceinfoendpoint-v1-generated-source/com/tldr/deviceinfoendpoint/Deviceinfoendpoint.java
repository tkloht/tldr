 ...
 * on 2013-05-14 at 19:17:29 UTC 
 * Modify at your own risk.
 */

package com.tldr.deviceinfoendpoint;
 ...
 * 
 * <p>
 * This service uses {@link DeviceinfoendpointRequestInitializer} to initialize
...
public class Deviceinfoendpoint extends
	 ...
	 * 
	 * This request holds the parameters needed by the the deviceinfoendpoint
	 * server. After setting any optional parameters, call the
	 * {@link GetDeviceInfo#execute()} method to invoke the remote operation.
	 * 
	 * @param id
	 * @return the request
	 */
	public GetDeviceInfo getDeviceInfo(java.lang.String id)
			throws java.io.IOException {
	...
	public class GetDeviceInfo
			extends
			DeviceinfoendpointRequest<com.tldr.deviceinfoendpoint.model.DeviceInfo> {
		 ...
		 * deviceinfoendpoint server. After setting any optional parameters,
		 * call the {@link GetDeviceInfo#execute()} method to invoke the remote
		 * operation.
		 * <p>
		 * {@link GetDeviceInfo#initialize(com.google.api.client.googleapis.services.Abstra ctGoogleClientRequest)}
		...
		protected GetDeviceInfo(java.lang.String id) {
			super(Deviceinfoendpoint.this, "GET", REST_PATH, null,
					com.tldr.deviceinfoendpoint.model.DeviceInfo.class);
	 ...
	 * This request holds the parameters needed by the the deviceinfoendpoint
	 * server. After setting any optional parameters, call the
	 * {@link InsertDeviceInfo#execute()} method to invoke the remote operation.
	 * 
	 * @param content
	 *            the {@link com.tldr.deviceinfoendpoint.model.DeviceInfo}
	 * @return the request
	 */
	public InsertDeviceInfo insertDeviceInfo(
			com.tldr.deviceinfoendpoint.model.DeviceInfo content)
			throws java.io.IOException {
	...
	public class InsertDeviceInfo
		 ...
		 * This request holds the parameters needed by the the
		 * deviceinfoendpoint server. After setting any optional parameters,
		 * call the {@link InsertDeviceInfo#execute()} method to invoke the
		 * remote operation.
		 * <p>
		 * {@link
		 * InsertDeviceInfo#initialize(com.google.api.client.googleapis.servi
		 * ces.AbstractGoogleClientRequest)} must be called to initialize this
		 ...
		 * @since 1.13
		 */
		protected InsertDeviceInfo(
				com.tldr.deviceinfoendpoint.model.DeviceInfo content) {
			super(Deviceinfoendpoint.this, "POST", REST_PATH, content,
					com.tldr.deviceinfoendpoint.model.DeviceInfo.class);
		}
	 ...
	 * This request holds the parameters needed by the the deviceinfoendpoint
	 * server. After setting any optional parameters, call the
	 * {@link ListDeviceInfo#execute()} method to invoke the remote operation.
	 * 
	 * @return the request
	 */
	...
	public class ListDeviceInfo
			extends
			DeviceinfoendpointRequest<com.tldr.deviceinfoendpoint.model.CollectionResponseDeviceInfo> {
		 ...
		 * This request holds the parameters needed by the the
		 * deviceinfoendpoint server. After setting any optional parameters,
		 * call the {@link ListDeviceInfo#execute()} method to invoke the remote
		 * operation.
		 * <p>
		 * {@link ListDeviceInfo#initialize(com.google.api.client.googleapis.services.Abstr actGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 * 
		...
		protected ListDeviceInfo() {
			super(
					Deviceinfoendpoint.this,
					"GET",
					REST_PATH,
					null,
					com.tldr.deviceinfoendpoint.model.CollectionResponseDeviceInfo.class);
		}
	 ...
	 * This request holds the parameters needed by the the deviceinfoendpoint
	 * server. After setting any optional parameters, call the
	 * {@link RemoveDeviceInfo#execute()} method to invoke the remote operation.
	 * 
	 * @param id
	 * @return the request
	 */
	public RemoveDeviceInfo removeDeviceInfo(java.lang.String id)
			throws java.io.IOException {
	...
	public class RemoveDeviceInfo
		 ...
		 * This request holds the parameters needed by the the
		 * deviceinfoendpoint server. After setting any optional parameters,
		 * call the {@link RemoveDeviceInfo#execute()} method to invoke the
		 * remote operation.
		 * <p>
		 * {@link
		 * RemoveDeviceInfo#initialize(com.google.api.client.googleapis.servi
		 * ces.AbstractGoogleClientRequest)} must be called to initialize this
		 * instance immediately after invoking the constructor.
		 * </p>
		 * 
		...
		protected RemoveDeviceInfo(java.lang.String id) {
			super(Deviceinfoendpoint.this, "DELETE", REST_PATH, null,
					com.tldr.deviceinfoendpoint.model.DeviceInfo.class);
			this.id = com.google.api.client.util.Preconditions.checkNotNull(id,
					"Required parameter id must be specified.");
		}
	 ...
	 * This request holds the parameters needed by the the deviceinfoendpoint
	 * server. After setting any optional parameters, call the
	 * {@link UpdateDeviceInfo#execute()} method to invoke the remote operation.
	 * 
	 * @param content
	 *            the {@link com.tldr.deviceinfoendpoint.model.DeviceInfo}
	 * @return the request
	 */
	public UpdateDeviceInfo updateDeviceInfo(
			com.tldr.deviceinfoendpoint.model.DeviceInfo content)
			throws java.io.IOException {
	...
	public class UpdateDeviceInfo
		 ...
		 * This request holds the parameters needed by the the
		 * deviceinfoendpoint server. After setting any optional parameters,
		 * call the {@link UpdateDeviceInfo#execute()} method to invoke the
		 * remote operation.
		 * <p>
		 * {@link
		 * UpdateDeviceInfo#initialize(com.google.api.client.googleapis.servi
		 * ces.AbstractGoogleClientRequest)} must be called to initialize this
		 * instance immediately after invoking the constructor.
		 * </p>
		 * 
		 ...
		 * @since 1.13
		 */
		protected UpdateDeviceInfo(
				com.tldr.deviceinfoendpoint.model.DeviceInfo content) {
			super(Deviceinfoendpoint.this, "PUT", REST_PATH, content,
					com.tldr.deviceinfoendpoint.model.DeviceInfo.class);
		}
	...
	public static final class Builder
		...
		public Builder setDeviceinfoendpointRequestInitializer(
			...
			return (Builder) super
					.setGoogleClientRequestInitializer(deviceinfoendpointRequestInitializer);
		}
