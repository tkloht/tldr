...
package com.tldr.deviceinfoendpoint.model;
...
public final class CollectionResponseDeviceInfo extends
	...
	static {
		// hack to force ProGuard to consider DeviceInfo used, since otherwise
	 ...
	 */
	public CollectionResponseDeviceInfo setItems(
			java.util.List<DeviceInfo> items) {
		this.items = items;
		return this;
	}
	 ...
	 */
	public CollectionResponseDeviceInfo setNextPageToken(
