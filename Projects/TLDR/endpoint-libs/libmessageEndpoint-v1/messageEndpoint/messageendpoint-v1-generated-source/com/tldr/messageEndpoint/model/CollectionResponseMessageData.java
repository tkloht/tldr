...
package com.tldr.messageEndpoint.model;
...
public final class CollectionResponseMessageData extends
	...
	static {
		// hack to force ProGuard to consider MessageData used, since otherwise
	 ...
	 */
	public CollectionResponseMessageData setItems(
			java.util.List<MessageData> items) {
		this.items = items;
		return this;
	}
	 ...
	 */
	public CollectionResponseMessageData setNextPageToken(
