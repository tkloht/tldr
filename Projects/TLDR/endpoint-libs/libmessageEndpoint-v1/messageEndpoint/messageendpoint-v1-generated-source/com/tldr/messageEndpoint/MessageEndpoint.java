 ...
 * on 2013-05-14 at 19:17:39 UTC 
 * Modify at your own risk.
 */

package com.tldr.messageEndpoint;
 ...
 * 
 * <p>
 * This service uses {@link MessageEndpointRequestInitializer} to initialize
...
public class MessageEndpoint extends
	 ...
	 * 
	 * This request holds the parameters needed by the the messageEndpoint
	 * server. After setting any optional parameters, call the
	 * {@link ListMessages#execute()} method to invoke the remote operation.
	 * 
	 * @return the request
	 */
	...
	public class ListMessages
			extends
			MessageEndpointRequest<com.tldr.messageEndpoint.model.CollectionResponseMessageData> {
		 ...
		 * {@link ListMessages#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link ListMessages#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		...
		protected ListMessages() {
			super(
					MessageEndpoint.this,
					"GET",
					REST_PATH,
					null,
					com.tldr.messageEndpoint.model.CollectionResponseMessageData.class);
		}
	 ...
	 * This request holds the parameters needed by the the messageEndpoint
	 * server. After setting any optional parameters, call the
	 * {@link SendMessage#execute()} method to invoke the remote operation.
	 * 
	 * @param message
	 * @return the request
	 */
	public SendMessage sendMessage(java.lang.String message)
			throws java.io.IOException {
	...
	public class SendMessage extends MessageEndpointRequest<Void> {
		 ...
		 * {@link SendMessage#execute()} method to invoke the remote operation.
		 * <p>
		 * {@link SendMessage#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
		 * must be called to initialize this instance immediately after invoking
		 * the constructor.
		 * </p>
		 * 
		...
		protected SendMessage(java.lang.String message) {
			...
			this.message = com.google.api.client.util.Preconditions
					.checkNotNull(message,
							"Required parameter message must be specified.");
		}
	...
	public static final class Builder
		...
		public Builder setMessageEndpointRequestInitializer(
			...
			return (Builder) super
					.setGoogleClientRequestInitializer(messageendpointRequestInitializer);
		}
