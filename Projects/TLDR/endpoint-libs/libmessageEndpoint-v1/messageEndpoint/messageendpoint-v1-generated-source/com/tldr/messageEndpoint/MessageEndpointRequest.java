...
public abstract class MessageEndpointRequest<T>
		extends
	 ...
	 */
	public MessageEndpointRequest(MessageEndpoint client, String method,
	...
	/** Returns response with indentations and line breaks. */
	public MessageEndpointRequest<T> setPrettyPrint(
	...
	@Override
	public MessageEndpointRequest<T> setDisableGZipContent(
			boolean disableGZipContent) {
		return (MessageEndpointRequest<T>) super
				.setDisableGZipContent(disableGZipContent);
	}

	@Override
	public MessageEndpointRequest<T> setRequestHeaders(
